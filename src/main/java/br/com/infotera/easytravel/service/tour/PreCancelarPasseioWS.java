...
@Service
public class PreCancelarPasseioWS {
        ...
        try {
            for (WSReservaServico servico : reservaRQ.getReserva().getReservaServicoList()) {
                try {
                    ...
                    Logger.getLogger(PreCancelarPasseioWS.class.getName()).log(Level.SEVERE, null, ex);
                }
            ...
            throw new ErrorException(reservaRQ.getIntegrador(), PreCancelarPasseioWS.class, "verificarCancelamento", WSMensagemErroEnum.SPC, 
