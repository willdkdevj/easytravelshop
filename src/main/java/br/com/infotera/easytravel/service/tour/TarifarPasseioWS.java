...
//                        String dsParametro = UtilsWS.montarParametro(tarifarServicoRQ.getIntegrador(), tour, dtServicoInicio, dtServicoFim, search.getSearchId(), WSServicoTipoEnum.PASSEIO);
//
