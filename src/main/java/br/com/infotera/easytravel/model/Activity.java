...
public class Activity {
    ...
    public Activity(String activityId, ServiceType serviceType, String activityType, String name, String description, String descriptionAdditional, String observation, Boolean onrequest, Boolean insurance, Integer sequence, BestPrice bestPrice, String bestDate, List<Transfer> transfers, List<Tour> tours, List<Ticket> tickets, List<Image> images, List<Location> locations, List<CancellationPolicy> cancellationPolicies, List<Category> categories, List<RequiredDocument> requiredDocuments, boolean combo) {
